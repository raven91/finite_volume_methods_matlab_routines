function [] = ErrorConvergenceForDiffusionEquation1D
    ...
    t_0 = 0; 
    t_1 = t_0;
    folder = '/Users/nikita/Documents/Projects/spc2/spc2FiniteVolumeMethods/TestCaseDiffusionEquation1D/';
    size_of_float = 4;
...
%     loglog(x, x, '--k', 'LineWidth', 2.5);
    loglog(x, 10^(-4.8) * x .^ 2, '--k', 'LineWidth', 2.5);
